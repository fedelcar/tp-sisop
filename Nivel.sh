cd
cd /home/utnso/git/tp-20131c-tp-so-1c2013/Libreria-nivel/Debug
make clean
make
cd
...
make
cd
cd /home/utnso/git/tp-20131c-tp-so-1c2013/Nivel/Debug
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/utnso/git/tp-20131c-tp-so-1c2013/Libreria-nivel/Debug
ldd Nivel
cd /home/utnso/git/tp-20131c-tp-so-1c2013/Nivel/Debug
./Nivel $1
